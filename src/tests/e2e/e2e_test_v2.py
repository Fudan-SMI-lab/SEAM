...
from core.telemetry_bridge import TelemetryBridge  # pylint: disable=wrong-import-position; silent
...
def build_v2_summary(  # pylint: disable=too-many-arguments,too-many-locals; silent
    *,
    run_id: str,
    base_url: str,
    output_dir: str,
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Run YAML-driven migration_utils E2E migration workflow."
    )
