...
7. After applying the fix, you MUST try running the project entry script yourself. Use the framework-provided execution command or the current Phase 3 `run_command`; do not assume a project `.venv` exists.
