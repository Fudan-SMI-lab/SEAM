...
def write_ascend_serving_validation_wrapper(
    *,
    ...
    replacements = {
        ...
        "__READINESS_PROBE_JSON__": _python_json_loads_literal(readiness_probe if isinstance(readiness_probe, Mapping) else {}),
        "__REQUEST_VALIDATION_JSON__": _python_json_loads_literal(request_validation if isinstance(request_validation, Mapping) else {}),
