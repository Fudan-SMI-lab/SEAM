...
class MockSessionManager:
    ...
    def send_command(
        ...
        self, session_id: str, command: str, timeout: int | None = None, **kwargs: object
    ) -> str:
...
def verify_run(  # pylint: disable=too-many-arguments,too-many-branches,too-many-locals; silent
    *,
    temp_root: Path,
    source_file: Path,
    artifact_store: ArtifactStore,
