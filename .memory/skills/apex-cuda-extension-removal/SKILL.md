...
## When to Use
- Error involves: from apex import amp, from apex_C import fused_layer_norm, from apex.normalization import FusedLayerNorm, from apex.optimizers import FusedAdam, FusedSGD, FusedLAMB, model, optimizer = amp.initialize(model, optimizer, ...), with amp.scale_loss(loss, optimizer) as scaled_loss:, attn = apex_C.fused_layer_norm(input_tensor), from apex.parallel import DistributedDataParallel as ApexDDP
...
- Source runs: e2e-v2-dd160bf52029-exp-20260430002139
