...
## Quarantine
This historical ATen/CppExtension guidance is retained for audit only. Strict custom-op FULL_PASS now requires Ascend C/CANN OPP producer artifacts, so this skill must not be injected as active runtime guidance.
