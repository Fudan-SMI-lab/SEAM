...
# Hallo 迁移
bash src/scripts/run_seam.sh 01_Hallo --hostname 127.0.0.1 --port 4098 --server_type opencode

# ChaiLab 迁移
bash src/scripts/run_seam.sh 02_ChaiLab --hostname 127.0.0.1 --port 4098 --server_type opencode

# 如需更详细的 Phase 5 迭代次数 (默认 8)
bash src/scripts/run_seam.sh 01_Hallo --hostname 127.0.0.1 --port 4098 --server_type opencode --max-iter 12
```
...
bash src/scripts/run_seam.sh 01_Hallo --hostname 127.0.0.1 --port 4098 --server_type opencode --no-review
